...
// PHOENIX PROTOCOL - API MASTER V12.0 (ADMIN MANAGEMENT)
// 1. ADDED: updateSubscription() for managing dates/status.
// 2. ADDED: promoteToFirm() for upgrading users.
// 3. STATUS: Complete data layer for the new dashboard.
