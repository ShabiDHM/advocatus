...
// PHOENIX PROTOCOL - FINANCE TAB V10.3 (MOBILE TAB FIX)
// 1. FIX: Made the tab navigation horizontally scrollable on mobile to prevent overflow.
// 2. ADDED: Self-contained 'no-scrollbar' utility style.
