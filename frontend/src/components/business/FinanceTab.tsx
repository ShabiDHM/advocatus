...
// PHOENIX PROTOCOL - FINANCE TAB V18.2 (TYPE SAFETY FIX)
// 1. FIX: Added a fallback for i18n.language to prevent passing null to apiService.
...
export const FinanceTab: React.FC = () => {
    ...
    // PHOENIX FIX: Added fallback to 'sq' to prevent passing null to apiService
