...
// PHOENIX PROTOCOL - FINANCE TAB V8.7 (PROPS FIX)
// 1. FIX: Removed obsolete 'onMinimize' prop from PDFViewerModal call.
...
export const FinanceTab: React.FC = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            ...
            {/* PHOENIX FIX: REMOVED onMinimize prop */}
