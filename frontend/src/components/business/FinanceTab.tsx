...
// PHOENIX PROTOCOL - FINANCE TAB V8.6 (INVOICE STATUS AUTOMATION)
// 1. UI: Removed manual Status selector from Invoice Modal.
// 2. LOGIC: New invoices now default to 'PAID' status automatically.
// 3. STATUS: Simplified workflow.
...
export const FinanceTab: React.FC = () => {
    ...
    // PHOENIX FIX: Default status set to 'PAID'
    ...
    const closeInvoiceModal = () => { 
        ...
        // PHOENIX FIX: Reset default status to PAID
        setNewInvoice({ 
            client_name: '', client_email: '', client_phone: '', client_address: '', 
            client_city: '', client_tax_id: '', client_website: '', 
            tax_rate: 18, notes: '', status: 'PAID', related_case_id: ''
