              ...
              {hoveredEdge && (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs font-bold text-slate-200 bg-[#111827] p-3 rounded-xl border border-slate-800">
                    <span className="text-white font-black text-sm">{translateToAlbanian(nodeMap.get(hoveredEdge.source)?.label) || 'Burimi'}</span>
                    <Link2 size={14} className="text-blue-400 shrink-0 mx-2" />
                    <span className="text-white font-black text-sm">{translateToAlbanian(nodeMap.get(hoveredEdge.target)?.label) || 'Caku'}</span>
                  </div>
