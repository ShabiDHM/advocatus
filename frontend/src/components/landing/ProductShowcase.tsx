...
// PHOENIX PROTOCOL - LANDING PRESENTATION V2.0 (MOBILE FIRST)
// 1. MOBILE: Implemented Horizontal Tab Bar for small screens.
// 2. LAYOUT: Adaptive Grid (1 column mobile, 2 columns desktop).
// 3. UX: Adjusted mockup heights to fit phone screens (300px vs 500px).
    ...
    return (
        <div className="py-16 lg:py-24 bg-background-dark relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="lg:hidden flex overflow-x-auto gap-3 mb-8 no-scrollbar pb-2">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="w-full h-full bg-gray-900 rounded-3xl border border-glass-edge shadow-2xl overflow-hidden relative flex flex-col">
                                    ...
                                    {/* Mobile Only Description Footer inside the Card */}
    ...
    <div className="space-y-2 lg:space-y-3 h-full flex flex-col justify-center">
        {[1, 2, 3, 4].map((i) => (
            <motion.div 
                ...
                className="flex items-center justify-between p-2 lg:p-3 bg-white/5 border border-white/5 rounded-lg"
            >
                <div className="flex items-center gap-3">
                    <div className="p-1.5 lg:p-2 bg-blue-500/10 rounded"><FileText className="w-3 h-3 lg:w-4 lg:h-4 text-blue-400" /></div>
                    <div className="space-y-1">
                        <div className="h-1.5 lg:h-2 w-16 lg:w-24 bg-gray-700 rounded" />
                        <div className="h-1 lg:h-1.5 w-10 lg:w-16 bg-gray-800 rounded" />
                    </div>
                </div>
                <div className="flex items-center gap-2 lg:gap-3">
                    <div className="w-16 lg:w-24 h-1 lg:h-1.5 bg-gray-800 rounded-full overflow-hidden">
                        <motion.div 
                            initial={{ width: 0 }}
                            animate={{ width: "100%" }}
...
const DraftingMockup = () => (
    <div className="relative h-full flex flex-col">
        ...
        <motion.div 
            ...
            className="absolute bottom-2 lg:bottom-10 right-0 left-0 mx-2 lg:mx-4 p-3 bg-indigo-900/80 backdrop-blur border border-indigo-500/50 rounded-xl"
        >
            <div className="flex items-center gap-2 mb-1">
                <BrainCircuit className="w-3 h-3 lg:w-4 lg:h-4 text-indigo-300" />
                <span className="text-[9px] lg:text-[10px] text-indigo-200 font-bold uppercase">Juristi AI</span>
            </div>
    ...
    <div className="grid grid-cols-2 gap-3 lg:gap-4 h-full content-center">
        {[1, 2, 3, 4].map(i => (
            <motion.div 
                ...
                className="aspect-square bg-gray-800/50 border border-white/5 rounded-xl p-3 lg:p-4 flex flex-col items-center justify-center gap-2 lg:gap-3 cursor-pointer"
            >
