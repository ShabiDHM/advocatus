...
// PHOENIX PROTOCOL - SIDEBAR V3.1 (SUPPORT LINK RELOCATED)
// 1. UX: Removed the 'Support' link from the main navigation array.
// 2. DEPENDENCIES: Removed the unused 'MessageSquare' icon import.
...
} from 'lucide-react'; // REMOVED: MessageSquare icon
