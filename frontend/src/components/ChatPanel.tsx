...
// PHOENIX PROTOCOL - CHAT PANEL V2.3 (TEXT OVERFLOW FIX)
// 1. FIX: Added 'break-words' class to chat bubbles to force text wrapping.
// 2. STATUS: Professional layout preserved.
            ...
            messages.map((msg, idx) => {
                ...
                return (
                    <motion.div key={idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className={`flex items-end gap-2 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                        ...
                        {/* PHOENIX FIX: Added 'break-words' to class list */}
