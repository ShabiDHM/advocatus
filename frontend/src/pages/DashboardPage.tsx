    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8 h-full flex flex-col relative bg-canvas">
      ...
      <div className="flex flex-row justify-between items-end mb-8 gap-4 px-2">
        ...
        <button 
            ...
            className="btn-primary flex items-center gap-3 px-6 py-3.5 rounded-2xl font-black text-xs uppercase tracking-[0.1em] active:scale-[0.98] shrink-0"
        >
      ...
      <AnimatePresence>
        {showCreateModal && (
          <div className="fixed inset-0 bg-canvas/60 backdrop-blur-xl flex items-center justify-center z-[100] p-4">
            <motion.div 
              ...
              className="glass-panel w-full max-w-lg p-8 sm:p-10 rounded-[3rem] shadow-2xl border border-main"
            >
              ...
              <form onSubmit={handleCreateCase} className="space-y-6">
                ...
                <div className="pt-6 border-t border-main space-y-5">
                ...
                <div className="flex justify-between items-center mt-10">
                  ...
                  <button type="submit" disabled={isCreating} className="btn-primary px-10 h-14 rounded-2xl flex items-center justify-center gap-3 active:scale-95 text-xs uppercase tracking-widest disabled:opacity-50">
        ...
        {caseToDeleteId && (
          <div className="fixed inset-0 bg-canvas/60 backdrop-blur-xl flex items-center justify-center z-[110] p-4">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="glass-panel w-full max-w-md p-10 rounded-[3rem] shadow-2xl text-center border border-danger-start/30">
              <div className="w-20 h-20 bg-danger-start/10 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-danger-start/20 shadow-inner">
              ...
              <div className="flex justify-center gap-5">
                <button type="button" onClick={() => setCaseToDeleteId(null)} className="btn-secondary flex-1 h-14 rounded-2xl text-[10px] uppercase tracking-widest">{t('general.cancel', 'Anulo')}</button>
                <button type="button" onClick={confirmDeleteCase} disabled={isDeletingCase} className="flex-1 h-14 rounded-2xl bg-danger-start hover:bg-danger-start/80 text-text-primary font-black shadow-lg flex items-center justify-center gap-3 active:scale-95 text-[10px] uppercase tracking-widest disabled:opacity-50 transition-all">
