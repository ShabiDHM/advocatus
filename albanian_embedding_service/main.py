# albanian_embedding_service/main.py
# DEFINITIVE VERSION 2.0: ENV Variable Fix
#   - FIX: Corrected environment variable lookup from MODEL_NAME to EMBEDDING_MODEL.
...
async def lifespan(app: FastAPI):
    ...
    # FIX: Read the model name from EMBEDDING_MODEL, which is passed via docker-compose.yml.
    # The default is ONLY for development and safety. Production uses the ENV.
