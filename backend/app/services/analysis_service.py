...
async def cross_examine_case(db: Database, case_id: str, user_id: str) -> Dict[str, Any]:
    ...
    {
      "executive_summary": "### 👨‍💼 UDHËZUESI PËR QYTETARIN (Gjuhë e Thjeshtë)\\n[Shpjegimi i thjeshtë pa terma ligjor]\\n\\n### ⚖️ ANALIZA PROFESIONALE E AVOKATIT\\n[Analiza teknike ligjore]",
      "legal_audit": {
          "burden_of_proof": "Kush e mban barrën e provës dhe pse? Cilat janë pikat ku paditësi ka dështuar të provojë pretendimet e tij?",
          "legal_basis": [
            {
      ...
      "strategic_recommendation": {
          "recommendation_text": "Analiza strategjike – çfarë rrugësh procedurale duhen ndjekur menjëherë?",
          "strengths": ["Lista e pikave të forta të rastit tonë procedurale ose materiale"],
      ...
      "missing_evidence": ["Çfarë provash ose dokumentesh specifike origjinale duhen siguruar?"]
    }
    """
