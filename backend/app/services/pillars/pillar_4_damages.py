...
class Pillar4DamagesService:
    ...
    - Baza statutore për Masat e Sigurimit të Kërkesëpadisë / Urdhrat Emergjentë Mbrojtës
    """
    ...
    def build_prompt(
        ...
        DOKTRINA E DËMEVE DHE MASAVE NË KOSOVË:
        1. DËMI MATERIAL (LMD): Shpenzimet e procedurave, avokatisë, ekspertizave dhe dëmit të drejtpërdrejtë pasuror.
        2. DËMI JOMATERIAL (LMD): Dhimbja shpirtërore e pësuar, cenimi i autoritetit prindëror/personal, trauma emocionale e fëmijës dhe izolimi i padrejtë.
        3. KAMATA LIGJORE: Apliko kamatën ligjore vonesore prej 8% në vit nga momenti i lindjes së dëmit/paraqitjes së kërkesës sipas LMD-së.
        4. MASAT EMERGJENTE:
        ...
        MISIONI (KARTA 4):
        Përpilo llogaritjen e plotë të dëmeve të bazuara në shkresat e fashikullit dhe argumento masat emergjente mbrojtëse në favor të klientit tonë {client_name}.
        ...
        ### 1. 💶 TABELA E DËMIT MATERIAL (Shpenzimet gjyqësore, avokatia, ekspertizat dhe dëmi real)
        ### 2. 🧠 TABELA E DËMIT JOMATERIAL (Cenimi i integritetit, dinjitetit, dhimbja shpirtërore dhe stresi i shkaktuar)
