...
# PHOENIX PROTOCOL - SMART INCREMENTAL INGESTOR V14.0 (DIFF-HASH CACHING & FAST SKIP)
...
def run_smart_master_sync(force_clean_all: bool = False):
    ...
    # =========================================================================
    # ⚖️ FAZA 1: LIGJET STATUTORE (data/laws/ks)
    # =========================================================================
    print("\n" + "="*60)
    ...
    for file_path in law_files:
        ...
        logger.info(f"🔄 Duke procesuar ligjin e ri/modifikuar: {fname}...")
    ...
    # =========================================================================
    # 🏛️ FAZA 2: VENDIMET E GJYKATËS SUPREME (data/case_law)
    # =========================================================================
    print("\n" + "="*60)
    ...
    for file_path in caselaw_files:
        ...
        logger.info(f"🔄 Duke procesuar skedarin e ri suprem: {fname}...")
        coll.delete_many({"source": fname})
    ...
    # =========================================================================
    # 📚 FAZA 3: AKADEMIA E DREJTËSISË (data/academic)
    # =========================================================================
    print("\n" + "="*60)
    ...
    for file_path in academic_files:
        ...
        logger.info(f"🔄 Duke procesuar materialin e ri të Akademisë: {fname}...")
        coll.delete_many({"source": fname})
    ...
    print("\n" + "="*60)
    print("🏁 RAPORTI I SINKRONIZIMIT TË ZGJUAR:")
...
if __name__ == "__main__":
    ...
    run_smart_master_sync(force_clean_all=force_clean)